...
public class WordLine extends JFrame implements ActionListener{
    JFrame frame;
    JMenuBar bar;
    JMenu fileMenu,listMenu;
    JMenuItem Open,Exit,A,E,I,O,U;
    String filename,line,word;
    JTextArea printtext,Atext,Etext,Itext,Otext,Utext,wordline;
    ...
    WordLine() {
        ...
        wordline = new JTextArea(30,30);
        frame.add(wordline);
        wordline.setEditable(false);
    ...
    public void actionPerformed(ActionEvent e) {
       if(e.getSource() == Open) { // OPEN BUTTON
        ...
        if(x == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                //THIS WILL READ THE LINE FROM THE TXT FILE AND APPEND IT TO JFRAME WITHOUT PRINTING OUT THE LINE
            ...
            try {
                //THIS WILL READ THE LINE FROM THE TXT FILE AND APPEND IT TO JFRAME WITH PRITING OUT THE LINE NUMBER
                reader = new BufferedReader(new FileReader(filename));
                while((line = reader.readLine()) != null) {
                    wordline.append(l + ". " + line + "\n");
                    l++;
                }
                reader.close();
            } catch (IOException e1) {
